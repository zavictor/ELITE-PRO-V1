...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`єхplσríng thє frσntíєrs σf αrtífícíαl íntєllígєncє, tσgєthєr!. User: ${ownername}`).catch(_ => _)
        }
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Premium? Just chat with the ElitePro wa.me/917466008456 😉`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on Channel https://whatsapp.com/channel/0029VaXaqHII1rcmdDBBsd3g`,
                            thumbnailUrl: 'https://graph.org/file/3e81c19e2e4424a41eca2.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
            ...
            case 'donate':
            case 'donasi':
                let textnate = `Hello dear ${pushname}\n\nNo matter how much you donate is very valuable for us`
                XeonBotInc.sendMessage(m.chat, {
                    text: '*Opay:* Bank- 7047504860\n\n' + textnate
                }, {
                    quoted: m
                })
                break
...
XeonBotInc.sendMessage(from, { text : `Hi @${sender.split("@")[0]}, Here is my current user🧑‍💻`, mentions: [sender]}, { quoted: repf })
}
break
            case 'sticker':
            case 'stiker':
